...
const DEFAULT_VIEWPORT_OPTIONS: Partial<ICompleteViewportOptions> = {
    screenWidth: 0, // typeof window === 'undefined' ? 0 : window.innerWidth,
    screenHeight: 0, // typeof window === 'undefined' ? 0 : window.innerHeight,
    worldWidth: null,
    worldHeight: null,
    threshold: 5,
    passiveWheel: true,
...
export class Viewport extends Container
{
     ...
     */
    resize(
        screenWidth: number = 0, // typeof window === 'undefined' ? 0 : window.innerWidth,
        screenHeight: number = 0, // typeof window === 'undefined' ? 0 : window.innerHeight,
        worldWidth?: number,
        worldHeight?: number
    ): void
    {
